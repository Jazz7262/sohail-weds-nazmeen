...
function Timeline() {
    ...
    return (
                    ...
                    <>
                        <div className="row">
                            <div className="col-lg-6 left" data-aos="fade-down">
                                <h1>Shukrana</h1>
                                <p>
                                    On Saturday, 14<sup>th</sup> October, 2023.
                                    <br />
                                    29<sup>th</sup> Rabi-ul-Awwal, 1445 Hijri,
                                    <br />
                                    Time: 09:00 PM.
                                </p>
                            </div>
                        ...
                        <div className="row">
                            ...
                            >
                                <h1>Nikaah</h1>
                                <p>
                                    On Sunday, 15<sup>th</sup> October, 2023,
                                    <br />
                                    30<sup>th</sup> Rabi-ul-Awwal, 1445 Hijri,
                                    <br /> Time: 12:45 PM.
                                </p>
                        ...
                        <div className="row">
                            ...
                            >
                                ...
                                <p>
                                    On Monday, 16<sup>th</sup> October, 2023,
                                    <br />
                                    01<sup>st</sup> Rabi-ul-Aakhir, 1445 Hijri,
                                    <br />
                                    Time: 01:45 PM.
                                </p>
        ...
        //                         <h1>Nikaah</h1>
        //                         <p>
        //                             On Saturday, 24<sup>th</sup> October, 2023,
        //                             <br />
        ...
        //                         <h1>Valima</h1>
        //                         <p>
        //                             On Sunday, 25<sup>th</sup> October, 2023,
        //                             <br />
